const cards = [
  ...
  },
  {
    ...
    "back_text": "Ginkgo biloba\n\n(maidenhair tree)\n\nyin (Chinese) = silver\nduo = apricot\nJapanese pronunciation = ginko\nbiloba (Latin) = two-lobed"
  },
  {
    "id": "card_86",
    ...
    "back_text": "Metasequoia glyptostroboides\n\n(dawn redwood)\n\nmeta (Greek) = with / sharing\nsequoia = which see\n(redwood genus)\nglyptostrobo (Latin) = resemble Glyptostrobus\n(a Chinese swamp cypress)\n-oides (La) = similar to"
  },
  {
    "id": "card_57",
    ...
    "back_text": "Buddleja davidii\n\n(butterfly bush)\n\nAfter Reverend Buddle (English botanist)\ndavidii = after Père Armand David\n(French missionary and plant collector in China)"
  },
  {
    "id": "card_65",
    ...
    "back_text": "Corylus avellana\n\n(hazel)\n\nkorys (Greek) = hood / helmet\n(calyx covering the nut)\navellana = after Avella near Naples\nwhere hazel is grown for its nuts"
  },
  {
    "id": "card_67",
    ...
    "back_text": "Cotinus coggygria\n\n(smoke tree)\n\ncotinus (Greek) = wild olive\n(has olive-like appearance)\ncoggygria (Greek) = incorrect interpretation of 'kokkugia'\n= old name for smoke tree\n= smoky feathery plumes"
  },
  const cards = [
  {
    "id": "card_49",
  ...
  },
  {
    ...
    {
    "id": "card_60",
    "front_image_url_1": "https://apps.rhs.org.uk/plantselectorimages/detail/JFCampsisxtagliabuanaIndianSummer1.JPG",
    "front_image_url_2": "https://apps.rhs.org.uk/plantselectorimages/detail/rera02511.jpg",
    "front_image_url_3": "https://apps.rhs.org.uk/plantselectorimages/detail/visi102101.jpg",
    "rhs_url": "https://www.rhs.org.uk/plants/331252/campsis-tagliabueana-indian-summer-(-kudian-pbr)/details",
    "back_text": "Campsis radicans 'Indian Summer'\n\n(trumpet vine)\n\nkampsis (Greek) = curving / bending\n(curved stamens)\nradicans (Latin) = trailing or rooting\n(adventitious roots for climbing)\n'Indian Summer' = blooming time + colour\n(late summer / early autumn)"
  }
  {
    "id": "card_83",
    ...
    "back_text": "Lonicera periclymenum 'Graham Thomas'\n\n(common honeysuckle)\n\nLonicera = after Adam Lonicer\n(German botanist)\npericlymenum (Greek) = woodbine / honeysuckle\nPericlymenus / Periklymenon = an Argonaut who could change shape, form, colour\nperikleia (Gr) = I entwine / to entwine around\n(entwining habit)"
  },
  {
    "id": "card_90",
    ...
    "back_text": "Parthenocissus quinquefolia\n\n(Virginia creeper)\n\nparthenos (Greek) = virgin / maiden\n(can produce seeds without pollination)\n-cissus = ivy\nquinquefolia (Latin) = five-leaved\ncompound palmate leaves\n'five-leaved virgin ivy'"
  },
  {
    "id": "card_110",
    ...
    "back_text": "Wisteria sinensis\n\n(Chinese wisteria)\n\nWisteria = after Caspar Wistar\n(Professor at the University of Pennsylvania)\nsinensis = Chinese\n(anticlockwise twining stem - to left)"
  }
];
  {
    "id": "card_83",
